@extends('Master.masterEditDokumenAdmin')
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-xl-8 col-lg-7 mx-auto">
                <div class="card shadow mb-2">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('dokumenAdmin.update', $documents->id) }}" method="POST"
                            ...
                            <a href="{{ route('dokumenAdmin.index') }}" class="btn btn-auto btn-primary shadow-sm">
