@extends('Master.masterCasesOperator')
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-xl-8 col-lg-7 mx-auto">
                <div class="card shadow mb-2">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('casesOperator.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                        ...
                        <div class="mb-3">
                         ...
                         <div class="mb-3">
                            ...
                            <a href="{{ route('casesOperator.index') }}" class="btn btn-auto btn-primary shadow-sm">
