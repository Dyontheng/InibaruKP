...
class DokumenTypeDirekturITController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('Layouts.ITDept.Direktur.dokumenMaster.dokumenType.index', compact('user', 'documents', 'jenisDataList', 'filterJenisData'));
    }
