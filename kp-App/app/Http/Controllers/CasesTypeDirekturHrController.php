...
class CasesTypeDirekturHrController extends Controller
{
    public function index(Request $request)
    {
        ...
        $query = Cases::where('departement', 'HrDept');
        ...
        return view('layouts.HrDept.Direktur.casesType.index', compact('user', 'cases', 'filterJenisCases', 'jenisCasesList'));
