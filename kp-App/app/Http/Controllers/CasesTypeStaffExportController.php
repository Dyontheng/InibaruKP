...
class CasesTypeStaffExportController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('layouts.ExportDept.Staff.casesType.index', compact('user', 'cases', 'filterJenisCases', 'jenisCasesList'));
