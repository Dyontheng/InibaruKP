...
class CasesTypeStaffHrController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('layouts.HrDept.Staff.casesType.index', compact('user', 'cases', 'filterJenisCases', 'jenisCasesList'));
