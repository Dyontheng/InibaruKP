...
class DokumenOperatorController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('layouts.Operator.dokumenMaster.dokumen.index', compact('user','documents'));
    ...
    {
        $user = Auth::user();
        return view('layouts.Operator.dokumenMaster.dokumen.tambah', compact('user'));    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dokumenOperator.index')->with('success', 'Dokumen berhasil ditambahkan!');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('layouts.Operator.dokumenMaster.dokumen.edit', compact('user', 'documents'));
    }
    ...
    public function update(Request $request, string $id)
  {
        ...
        return redirect()->route('dokumenOperator.index')->with('success', 'Dokumen berhasil diperbarui!');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('dokumenOperator.index')->with('success', 'Dokumen berhasil dihapus!');
    }
}
