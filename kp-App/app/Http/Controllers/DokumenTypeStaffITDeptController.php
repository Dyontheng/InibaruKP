...
class DokumenTypeStaffITDeptController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
       ...
       $user = Auth::user();
        ...
        return view('layouts.ITDept.Staff.dokumenMaster.dokumenType.index', compact('user', 'documents', 'jenisDataList', 'filterJenisData'));
    }
